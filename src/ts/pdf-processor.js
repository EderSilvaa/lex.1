...
class PDFProcessor {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.loading = true;
            try {
                yield this.loadPDFJS();
                yield this.configurePDFJS();
    ...
    loadPDFJS() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                console.log('📚 LEX: Verificando PDF.js (carregado como content script)...');
                // PDF.js já foi carregado como content script no manifest
    ...
    waitForPDFJS(resolve, reject) {
        ...
        const checkPDFJS = () => {
            ...
            if (attempts % 10 === 1) {
                console.log('🔍 LEX: Propriedades do window com "pdf":', Object.keys(window).filter(k => k.toLowerCase().includes('pdf')));
    ...
    getEnvironmentInfo() {
        ...
        return {
            ...
            manifestVersion: ((_c = (_b = (_a = chrome === null || chrome === void 0 ? void 0 : chrome.runtime) === null || _a === void 0 ? void 0 : _a.getManifest) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.manifest_version) || null,
     ...
     */
    extractTextFromPDF(pdfBlob, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            ...
            try {
                ...
                const maxPages = (_a = options === null || options === void 0 ? void 0 : options.maxPages) !== null && _a !== void 0 ? _a : numPages;
                const pagesToProcess = Math.min(maxPages, numPages);
                console.log(`📄 LEX: Processando ${pagesToProcess} de ${numPages} páginas...`);
                // Processar cada página
                const pageDelimiter = (_b = options === null || options === void 0 ? void 0 : options.pageDelimiter) !== null && _b !== void 0 ? _b : '\n\n--- Página {page} ---\n\n';
                for (let pageNum = 1; pageNum <= pagesToProcess; pageNum++) {
                    try {
                        ...
                        if ((options === null || options === void 0 ? void 0 : options.includePageNumbers) !== false) {
