...
into Lex_Engine, archives selected unmapped docs for manual review, and
...
class Migrator:
    ...
    def migrate_deep_channels(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        # Map Discord-specific settings to Lex_Engine config
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Migrate OpenClaw user state into Lex_Engine.")
