...
def cmd_sync(args) -> None:
    ...
    Scans all Lex_Engine profiles and creates host blocks for any that don't
...
def _host_key() -> str:
    """Return the active Honcho host key, derived from the current Lex_Engine profile."""
...
def _active_profile_name() -> str:
    """Return the active Lex_Engine profile name (respects --target-profile override)."""
    if _profile_override:
