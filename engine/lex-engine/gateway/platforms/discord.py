...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Lex. session")
        ...
        @tree.command(name="status", description="Show Lex. session status")
        ...
        @tree.command(name="stop", description="Stop the running Lex. agent")
        ...
        @tree.command(name="update", description="Update Lex_Engine to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the Lex. gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Lex. session in it")
