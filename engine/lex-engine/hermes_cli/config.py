"""
Configuration management for Lex_Engine.
...
def is_managed() -> bool:
    """Check if Lex_Engine is running in package-manager-managed mode.
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "Lex." header.
...
def show_config():
    ...
    print(color("│               Lex_Engine Configuration                │", Colors.CYAN))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.CYAN))
