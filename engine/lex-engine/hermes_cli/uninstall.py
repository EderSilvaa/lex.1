    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip the "# Lex_Engine" comment and following line
                legacy_brand_marker = '# ' + 'Hermes ' + 'Agent'
                if '# Lex_Engine' in line or legacy_brand_marker in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print(color("│                Lex_Engine Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    print()
    if full_uninstall:
        print(color("WARNING: This will permanently delete ALL Lex_Engine data!", Colors.RED, Colors.BOLD))
        ...
        print("This will remove the Lex_Engine code but keep your configuration and data.")
