"""
Gateway subcommand for Lex_Engine CLI.
...
def find_gateway_pids(exclude_pids: set | None = None, all_profiles: bool = False) -> list:
    ...
    Args:
        ...
        all_profiles: When ``True``, return gateway PIDs across **all**
            ...
            Lex_Engine profile are returned.
    """
...
SERVICE_DESCRIPTION = "Lex. Gateway - Messaging Platform Integration"
...
def _find_legacy_hermes_units() -> list[tuple[str, Path, bool]]:
    """Return ``[(unit_name, unit_path, is_system)]`` for legacy Lex_Engine gateway units.
...
def has_legacy_hermes_units() -> bool:
    """Return True when any legacy Lex_Engine gateway unit files exist."""
    return bool(_find_legacy_hermes_units())


def print_legacy_unit_warning() -> None:
    """Warn about legacy Lex_Engine gateway unit files if any are installed.
...
def remove_legacy_hermes_units(
    ...
    """Stop, disable, and remove legacy Lex_Engine gateway unit files.
...
def refresh_systemd_unit_if_needed(system: bool = False) -> bool:
    ...
    print(f"↻ Updated gateway {_service_scope_label(system)} service definition to match the current Lex_Engine install")
    return True
...
def refresh_launchd_plist_if_needed() -> bool:
    ...
    print("↻ Updated gateway launchd service definition to match the current Lex_Engine install")
    return True
...
def launchd_status(deep: bool = False):
    ...
    if launchd_plist_is_current():
        print("✓ Service definition matches the current Lex_Engine install")
    else:
        print("⚠ Service definition is stale relative to the current Lex_Engine install")
...
def _gateway_command_inner(args):
    ...
    if subcmd == "install":
        ...
        # Stop, disable, and remove legacy Lex_Engine gateway unit files from
