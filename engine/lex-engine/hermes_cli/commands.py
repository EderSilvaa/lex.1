...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Lex_Engine config/state", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Lex. is working", "Configuration",
    ...
    CommandDef("update", "Update Lex_Engine to the latest version", "Info",
               gateway_only=True),
