"""Lex_Engine CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Lex."                  # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " Lex. "            # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Lex."
...
- ``default`` — Classic Lex gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Lex legal desktop — graphite, white, and teal",
        "colors": {
            "banner_border": "#27323A",
            "banner_title": "#3BA7A3",
            "banner_accent": "#3BA7A3",
            "banner_dim": "#9CA3AF",
            "banner_text": "#F3F4F6",
            "ui_accent": "#3BA7A3",
            "ui_label": "#9CA3AF",
            ...
            "prompt": "#F3F4F6",
            "input_rule": "#27323A",
            "response_border": "#3BA7A3",
            "status_bar_bg": "#0B1115",
            "status_bar_text": "#E5E7EB",
            "status_bar_strong": "#3BA7A3",
            "status_bar_dim": "#6B7280",
            "status_bar_good": "#34D399",
            "status_bar_warn": "#EAB308",
            "status_bar_bad": "#F87171",
            "session_label": "#3BA7A3",
            "session_border": "#27323A",
        },
        "spinner": {
        ...
        "branding": {
            "agent_name": "Lex.",
            "welcome": "Welcome to Lex. Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " Lex. ",
            "prompt_symbol": "❯ ",
