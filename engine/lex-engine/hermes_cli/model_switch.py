...
_HERMES_MODEL_WARNING = (
    ...
    "for use with Lex_Engine. They lack the tool-calling capabilities "
...
def list_authenticated_providers(
    ...
    # Build reverse mapping: models.dev ID → Lex_Engine provider ID.
    ...
    if user_providers and isinstance(user_providers, dict):
        for ep_name, ep_cfg in user_providers.items():
            ...
            # ``base_url`` is Lex_Engine's canonical write key (matches
    ...
    if custom_providers and isinstance(custom_providers, list):
        ...
        for entry in custom_providers:
            ...
            if group_key not in groups:
                ...
                # Lex_Engine's own writer uses; a hyphen variant is accepted
            ...
            # active model. Lex_Engine's own writer (main.py::_save_custom_provider)
