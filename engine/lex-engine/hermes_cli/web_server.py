...
app = FastAPI(title="Lex_Engine", version=__version__)
...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",   "label": "Lex. Teal",    "description": "Classic dark teal — the canonical Lex. look"},
...
def start_server(
    ...
    *,
    ...
    print(f"  Lex_Engine Web UI → http://{host}:{port}")
