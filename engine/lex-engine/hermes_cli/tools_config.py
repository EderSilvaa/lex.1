"""
Unified tool configuration for Lex_Engine.

`hermes tools` and `Lex_Engine setup tools` both enter this module.
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    """Entry point for `hermes tools` and `Lex_Engine setup tools`.
    ...
    if getattr(args, "summary", False):
        ...
        print()
        return
    print(color("Lex_Engine Tool Configuration", Colors.CYAN, Colors.BOLD))
