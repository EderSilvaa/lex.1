"""
Backup and import commands for Lex_Engine CLI.
...
def run_backup(args) -> None:
    ...
    if not hermes_root.is_dir():
        print(f"Error: Lex_Engine home directory not found at {hermes_root}")
        sys.exit(1)
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if (has_config or has_env) and not args.force:
            print()
            print("Warning: Target directory already has Lex_Engine configuration.")
        ...
        print("Done. Your Lex_Engine configuration has been restored.")
