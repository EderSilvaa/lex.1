...
DEFAULT_AGENT_IDENTITY = (
    "You are Lex., an intelligent AI assistant for Brazilian legal workflows. "
    "You are helpful, knowledgeable, and direct. You assist users with legal "
    "workflows, document analysis, PJe/RPA operations, planning, research, "
    "writing and editing code, and executing actions via your tools. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "If the user asks about configuring, setting up, or using Lex_Engine "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Lex_Engine itself — its CLI, config, models, providers, tools, "
