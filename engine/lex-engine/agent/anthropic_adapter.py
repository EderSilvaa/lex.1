"""Anthropic Messages API adapter for Lex_Engine.

Translates between Lex_Engine's internal OpenAI-style message format and
...
def resolve_anthropic_token() -> Optional[str]:
    ...
    # This remains as a compatibility fallback for pre-migration Lex_Engine configs.
...
def run_hermes_oauth_login_pure() -> Optional[Dict[str, Any]]:
    ...
    print()
    print("Authorize Lex_Engine with your Claude Pro/Max subscription.")
    print()
    ...
    if is_oauth:
        ...
        for block in system:
            if isinstance(block, dict) and block.get("type") == "text":
                text = block.get("text", "")
                legacy_brand_name = "Hermes " + "Agent"
                text = text.replace(legacy_brand_name, "Claude Code")
