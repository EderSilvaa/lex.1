...
# Lex_Engine provider names → models.dev provider IDs
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Lex_Engine provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Lex_Engine traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Lex_Engine provider ID (e.g. "kilocode") or a models.dev
