...
class AIAgent:
    ...
    def __init__(
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"by Lex_Engine.  Choose a model with at least "
    ...
    def run_conversation(
        ...
        # are reused.  The system prompt is Lex_Engine's territory; plugins
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if (
                        ...
                        from hermes_constants import display_hermes_home as _dhh_fn
                        _dhh = _dhh_fn()
                        print(f"{self.log_prefix}     • Check ANTHROPIC_TOKEN in {_dhh}/.env for Lex_Engine-managed OAuth/setup tokens")
