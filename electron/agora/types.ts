export type AgoraColumnId = 'entrada' | 'especificacao' | 'execucao' | 'revisao' | 'pronto';
...
export const AGORA_COLUMNS: AgoraColumnId[] = ['entrada', 'especificacao', 'execucao', 'revisao', 'pronto'];
