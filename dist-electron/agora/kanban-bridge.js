...
exports.isKanbanBridgeAvailable = isKanbanBridgeAvailable;
exports.runKanbanBridge = runKanbanBridge;
...
`;
function isKanbanBridgeAvailable() {
    return fs.existsSync((0, lex_engine_1.getLexEngineRepoPath)());
}
function runKanbanBridge(action, args = {}) {
    return new Promise((resolve, reject) => {
        const python = process.env['LEX_ENGINE_WINDOWS_PYTHON'] || 'python';
        const child = (0, child_process_1.execFile)(python, ['-c', PYTHON_BRIDGE], {
            cwd: (0, lex_engine_1.getLexEngineRepoPath)(),
            env: {
                ...process.env,
                ...(0, lex_engine_1.getLexEngineKanbanBridgeEnv)(),
                HERMES_KANBAN_HOME: (0, lex_engine_1.getLexEngineKanbanHomePath)(),
...
//# sourceMappingURL=kanban-bridge.js.map